...
import { DictionaryService } from '../../common/components/dictionary-select/dictionary.service';
import { CustomValidators } from '../../core/services/form-validation/custom-validators';
import { ActivityModel, ActivityTypeModel, DirectionModel, ProjectModel } from '../../server-api';
...
import { ActivityValidation } from './activity-dialog.model';
